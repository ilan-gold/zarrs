...
pub enum ArrayBytesFixedDisjointViewCreateError {
    ...
    IncompatibleIndexAndShapeError(#[from] IncompatibleIndexAndShapeError),
}
...
impl From<ArrayBytesFixedDisjointViewCreateError> for CodecError {
    fn from(value: ArrayBytesFixedDisjointViewCreateError) -> Self {
        match value {
            ...
            ArrayBytesFixedDisjointViewCreateError::IncompatibleIndexAndShapeError(e) => {
                e.into()
            }
        }
    }
...
impl<'a> ArrayBytesFixedDisjointView<'a> {
    ...
    pub unsafe fn subdivide(
        &self,
        subset: ArraySubset,
    ) -> Result<ArrayBytesFixedDisjointView<'_>, ArrayBytesFixedDisjointViewCreateError> {
